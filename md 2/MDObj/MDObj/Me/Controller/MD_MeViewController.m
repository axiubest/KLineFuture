...
@interface MD_MeViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
- (void)request {
    [[XIU_NetAPIClient sharedJsonClient]requestJsonDataWithPath:API_GetArena withParams:@{@"uid":[XIU_Login userId]} withMethodType:Post andBlock:^(id data, NSError *error) {
        [self.dic setObject:[data objectForKey:@"Income"] forKey:@"Oncome"];
        [self.dic setObject:[data objectForKey:@"Rate"] forKey:@"Rate"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == CellInformationStyle_Custom) {
        ...
        cell.money.text =[NSString stringWithFormat:@"%@万", [self.dic objectForKey:@"Oncome"]];
        cell.rate.text = [self.dic objectForKey:@"Rate"];
        return cell;
    }
