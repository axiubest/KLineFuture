...
- (void)setData:(NSMutableArray *)data {
    ...
    [_stock1 bk_whenTapped:^{
        [_delegate clickViewWithType:[data[0] Code]];
        
    }];
    [_stock2 bk_whenTapped:^{
        [_delegate clickViewWithType:[data[1] Code]];
        
    }];
    [_stock3 bk_whenTapped:^{
        [_delegate clickViewWithType:[data[2] Code]];
        
    }];
    [_stock4 bk_whenTapped:^{
        [_delegate clickViewWithType:[data[3] Code]];
        
    }];
    [_stock5 bk_whenTapped:^{
        [_delegate clickViewWithType:[data[4] Code]];
        
    }];
    [_stock6 bk_whenTapped:^{
        [_delegate clickViewWithType:[data[5] Code]];
