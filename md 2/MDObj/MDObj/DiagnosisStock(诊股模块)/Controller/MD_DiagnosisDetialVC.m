...
- (void)viewDidLoad {
    [super viewDidLoad];
    NSURL *musicUrl = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"getresult" ofType:@"mp3"]];
...
//    [_musicPlayer prepareToPlay];
    ...
    UIImageView *img = [[UIImageView alloc] initWithFrame:CGRectMake(40, 60, KWIDTH - 80, KHEIGHT - 240)];
...
-(XIU_DiagnosisPopView *)alertView {
    if (!_alertView) {
        ...
        view.frame = CGRectMake(-90 * SCREEN_SCALE, 0, self.view.width- 100, 300 *SCREEN_SCALE);
