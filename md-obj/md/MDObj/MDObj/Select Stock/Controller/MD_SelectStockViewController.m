...
- (void)clickBtnRequestWithId:(NSInteger)Id {
    //    btn.tag 即为Id值
    typeid = Id;
    [[XIU_NetAPIClient sharedJsonClient] requestJsonDataWithPath:API_ChooseStockForId withParams:@{@"id":[NSNumber numberWithInteger:Id]} withMethodType:Post andBlock:^(id data, NSError *error) {
