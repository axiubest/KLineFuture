...
- (void)drawDashLine {
    ...
    //绘制选中价格
    NSString *priceText = [NSString stringWithFormat:@"%.2f",[[self.selectedModel nowPrice] floatValue]];
    ...
    //绘制选中增幅
    NSString *text2 = [NSString stringWithFormat:@"%.2f%%",([[self.selectedModel nowPrice] floatValue] - [self.selectedModel AvgPrice])*100/[self.selectedModel AvgPrice]];
