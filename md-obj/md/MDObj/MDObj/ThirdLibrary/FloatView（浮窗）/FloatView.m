        ...
        if (removePoint.x + pan.view.center.x <= SCREEN_WIDTH/2 ) {
            ...
            if ( removePoint.y + pan.view.center.y <= 64) {
                ...
                if (removePoint.x + pan.view.center.x <= pan.view.frame.size.width/2) {
                    ...
                    [UIView animateWithDuration:0.2 animations:^{
                        pan.view.center = CGPointMake(pan.view.frame.size.width/2, pan.view.frame.size.height/2 + 64);
                    }];
                    for (FloatViewSubView *subView in self.subFloatViews) {
            ...
            if ( removePoint.y + pan.view.center.y <= 64) {
                    ...
                    if (removePoint.x + pan.view.center.x <= pan.view.frame.size.width/2) {
                        ...
                        for (FloatViewSubView *subView in self.subFloatViews) {
                            subView.center = CGPointMake(pan.view.frame.size.width/2 , pan.view.frame.size.height/2 + 64);
                        }
                        ...
                        [UIView animateWithDuration:0.2 animations:^{
                            pan.view.center = CGPointMake(SCREEN_WIDTH - pan.view.frame.size.width/2, pan.view.frame.size.height/2 + 64);
                        }];
                        for (FloatViewSubView *subView in self.subFloatViews) {
                            subView.center = CGPointMake(SCREEN_WIDTH - pan.view.frame.size.width/2, pan.view.frame.size.height/2 + 64);
                        }
                ...
                for (FloatViewSubView *subView in self.subFloatViews) {
                    subView.center = CGPointMake(removePoint.x + pan.view.center.x,pan.view.frame.size.height/2 + 64);
                }
                //清空移动的距离
                [pan setTranslation:CGPointZero inView:self.fatherView];
                ...
                if (removePoint.x + pan.view.center.x <= pan.view.frame.size.width/2) {
                    ...
                    [UIView animateWithDuration:0.2 animations:^{
                        pan.view.center = CGPointMake(SCREEN_WIDTH - pan.view.frame.size.width/2,  SCREEN_HEIGHT- pan.view.frame.size.height/2 + 64);
                    }];
                    for (FloatViewSubView *subView in self.subFloatViews) {
                        subView.center = CGPointMake(SCREEN_WIDTH - pan.view.frame.size.width/2,  SCREEN_HEIGHT- pan.view.frame.size.height/2 + 64);
                    }
                ...
                [UIView animateWithDuration:0.2 animations:^{
                    pan.view.center = CGPointMake(removePoint.x + pan.view.center.x , SCREEN_HEIGHT - pan.view.frame.size.height/2 + 64);
                }];
                for (FloatViewSubView *subView in self.subFloatViews) {
                    subView.center = CGPointMake(removePoint.x + pan.view.center.x, SCREEN_HEIGHT -pan.view.frame.size.height/2 + 64 );
                }
                //清空移动的距离
                [pan setTranslation:CGPointZero inView:self.fatherView];
                ...
                for (FloatViewSubView *subView in self.subFloatViews) {
                    subView.center = CGPointMake(SCREEN_WIDTH - pan.view.frame.size.width/2, removePoint.y + pan.view.center.y + 64);
                }
                //清空移动的距离
                [pan setTranslation:CGPointZero inView:self.fatherView];
